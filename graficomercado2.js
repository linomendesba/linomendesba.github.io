...
const SETUPS_KEY            = 'kiron:setups_v4';
const ACTIVE_SETUP_KEY      = 'kiron:activeSetup_v4';
const VISIBLE_DS_KEY        = 'kiron:visibleDatasets_v4';
const DRAG_LINES_KEY        = 'kiron:draglines';
const DRAG_FIBS_KEY         = 'kiron:dragfibs';
const ACCORDION_KEY         = 'kiron:accordionOpen';
const SETUP_LINE_TOGGLE_KEY = 'kiron:lineToggles_v4';
const Y_AXIS_POS_KEY        = 'kiron:yAxisPosition';
...
─────────────────────────────────────────── */
let numPoints          = 30;   // ← Kiron roda a 30 jogos/hora
let averagePoints      = 29;   // ← Base 30
...
function processApiData(data, league) {
    ...
    // Pega jogos suficientes: numPoints exibidos + janela de média em minutos reais (averagePoints * 2 min/jogo, pois a Kiron roda a 30 jogos/hora, + folga)
    ...
    // janela em minutos reais: averagePoints jogos * 2 min por jogo (Kiron = 30 jogos/hora)
