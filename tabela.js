...
function renderizarBadgesMercadosExtras(placarEl, oddsObj) {
 try {
  ...
  Estado.mercadosExtras.forEach(item => {
    ...
    b.style.cssText = `line-height:1;margin-top:1px;padding:1px 3px;border-radius:3px;color:#ffffff;white-space:nowrap;`;
...
(function injectStyles() {
  ...
  style.textContent = `
    ...
    .placar-futuro-odd { opacity:0.85; margin-top:1px; color:#dfdfdf; font-weight:bold; cursor:pointer; }
