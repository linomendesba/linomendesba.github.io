...
function criarTabela(dados, oddsData, proximosJogos) {
  ...
  minutosFixos.forEach((m, i) => {
    ...
    th.innerHTML = `${m}<span class="seq-jogo-header" style="color:#ffffff;font-size:10px;font-weight:600;margin-left:3px;">${(i+1).toString().padStart(2,"0")}</span>`;
